	...
	class Page
	{
		...
		*/
		...
		Login4399(user)
		{
			...
			PixelGetColor, l_OutputColor, 460, 956, RGB

			;MsgBox, % l_OutputColor1 . l_OutputColor2

			If ( l_OutputColor = "0xB5DF65" )      
			{
				click, 408 460,2				
				sleep 100
				;MsgBox, % user
				Switch user
				{
					...
					Case "sf06":
						send sf27_06
					Default:
						Throw, % "Not a correct user flag of: " . user
				}
			...
			else If ( l_OutputColor = "0xDFEF77" )
			{	
				click 311, 817
				sleep 200
				return 0				
			}
			else If ( l_OutputColor = "0xC9C679" or l_OutputColor = "0x8C8A54" or l_OutputColor = "0x65603C" ) ;homepage color
			{	
				return 1				
			}
			else if ( l_OutputColor = "0xECEFF4" or l_OutputColor = "0x3BC1FF" or l_OutputColor = "0x0x2D2E28") ; loading color
			{
				sleep 500
				return 0				
			}
			...
			{
				MouseMove, 460, 956,3
				MsgBox, % l_OutputColor . " is unexpected!"
				return 1
				;throw "unknow color while login"
			}			
		}
		...
		LoginQH(user)
		{
			...
			PixelGetColor, l_OutputColor, 332, 587, RGB
			PixelGetColor, l_OutputColoraux, 33, 763, RGB

			If ( l_OutputColor = "0x232F33" )   ;select the login ways   
			{
				if (user = "eight" or user = "dq")
				{
					click 371, 539
					sleep 200
				}
			...
			else if ( l_OutputColor = "0xF47500" )   ;login by platform account   
			{
				click, 295, 465,2				
				sleep 1000
			...
			else If ( l_OutputColoraux = "0xFFFFFF" )		; Login by QQ account
			{	

				if (user = "boy" or user = "steve")
				{
					click 298, 437
					sleep 2000
					click 295, 375
			...
			else If ( l_OutputColor = "0x6B422D" )		; The page with sever list and start button
			{	
				click 582, 103
				sleep 200
				if user = "eight" or user = "dq"
			...
			else If ( l_OutputColoraux = "0xFFBE67" or l_OutputColor = "0xB28548" or l_OutputColor = "0x7C5D32" ) ;homepage color
			{	
				return 1				
			}
			else		;other colors
