...
{ ; Class that handles writing to a log file
	...
	__New(aLogBaseFilename, aMaxNumbOldLogs=0, aMaxSizeMBLogFile=-1, aLogDir="", aLogExten="")
	{
		...
		this.maxNumbOldLogs_Default     := 5  ; -1 is infinite, 0 is only the current file (NOTE: If initalizeNewLogFile(overwriteExistingFile = -1) this is pretty much ignored except for tidy())
